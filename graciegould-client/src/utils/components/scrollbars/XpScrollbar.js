...
function XpScrollbarHorizontal({ 
    ...
    return (
        <div className="xp-scrollable-container-vertical">
            <div className="xp-scrollable-horizontal-body-overlay">{children}</div>
...
const VerticalScrollbar = ({
    ...
    verticalThumbColor = "#e4e3e3",
    verticalScrollbarColor = "#f1f1f1",
    scrollbarClassName = "xp-vertical-scrollbar",
    thumbClassName = "xp-vertical-scrollbar-thumb",
}) => {
...
const HorizontalScrollbar = ({
    ...
    horizontalThumbColor = "#e4e3e3",
    horizontalScrollbarColor = "#f1f1f1",
    scrollbarClassName = "xp-horizontal-scrollbar",
    thumbClassName = "xp-horizontal-scrollbar-thumb",
}) => {
